 ...
 */
        ...
        $this->bml_form->set_title('Bill Payment');
        $this->bml_form->set_ttl(1);
        $this->bml_form->set_action_url($this->config->item('nav_url') . 'billconfirmation?mmoperatorid=' . urlencode($mmoperatorid) . '&optionid=' . urlencode($optionid) . '&optionname=' . urlencode($optionname) . '&mmoperatorname=' . urlencode($mmoperatorname));
