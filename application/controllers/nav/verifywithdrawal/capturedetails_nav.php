...
$params = array(array('name' => 'Transaction ID or Token',
        'value' => '',
        'fullscreen' => 'false',
        'hidevalue' => 'false',
        'manditory' => 'true',
...
$this->bml_form->set_action_url($this->config->item('nav_url') . 'verifystatus?mmoperatorid=' . urlencode($mmoperatorid) . '&mmoperatorname=' . urlencode($mmoperatorname));
