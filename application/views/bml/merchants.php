...
function iterate_button_list($arguments) {
    $button_names = array('What is MATS service', 'How does the MATS gateway work', 'Why should I accept mobile money from all providers in Nigeria','What transaction fees are charged','Which MobileMoney providers do we work with','How do I get started as a Merchant','Why MATS');
