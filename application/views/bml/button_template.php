...
function display_button($button_name, $arguments) {
    ...
    $generated_button = '
     ...
     <link icon="n" x="' . $line_height . '" y="username_location +' . $line_height . '" w="' . $button_width . '" h="' . $button_size . '" spider="N" actionType="page" url="' . $nav_url . strtolower(str_replace(" ","_",trim($button_name))) .'/" style="button_link"/>
