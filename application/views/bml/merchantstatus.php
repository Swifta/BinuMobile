...
function status_page($arguments) {
    ...
    log_message('info', 'Inside the Merchant confirmation page answer page =====================================');
    ...
    if (!empty($errors)) {
        ...
        if ($status == 'true') {
            $text = 'Payment of ' . $bullet_naira . ' ' . number_format($amount, 2, '.', ',') . ' was successfully made and the ' . $mmoperatorname . ' ewallet credited for ' . $beneficiary_name . '
